...
var getEntryHandlebars = __webpack_require__(10);

var refreshWelcome = function refreshWelcome() {
  $('#welcome').hide();
...
var introWelcome = function introWelcome() {
  $('#welcome').hide();
...
var getTableData = function getTableData(a) {
  event.preventDefault();
  var selText = $(this).text();
  $('#tableButton').text(selText);
};

var exitEntries = function exitEntries(event) {
  $('#sign-out').show();
...
var resetAllForms = function resetAllForms(event) {
...
var clearModalAlert = function clearModalAlert(event) {
  $('.modal-alert').text('');
};

var signUpSuccess = function signUpSuccess(signUp) {
...
var signInError = function signInError(event) {
...
var signOutFailure = function signOutFailure(event) {
  $('.modal-alert').text('There was an error signing out. Try again.');
  resetAllForms();
  clearModalAlert();
};

var changePasswordSuccess = function changePasswordSuccess(event) {
  clearModalAlert();
  $('#sign-out').show();
  $('#change-password-button').show();
...
var changePasswordFailure = function changePasswordFailure(event) {
  clearModalAlert();
  $('.modal-alert').text('There was an error. Try again.');
  resetAllForms();
};

var createEntrySuccess = function createEntrySuccess(event) {
...
var createEntryFailure = function createEntryFailure(event) {
  $('.modal-alert').text('There was an error. Try again.');
};

var getEntriesSuccess = function getEntriesSuccess(data) {
  store.entries = data.entries;
  var getEntryHtml = getEntryHandlebars({ entries: data.entries });
...
var getEntriesFailure = function getEntriesFailure(event) {
...
var deleteEntryFailure = function deleteEntryFailure(event) {
  $('#delete-message').text('Entry may not exist. Click refresh.');
  $('input').val('');
};

var editEntryFailure = function editEntryFailure(event) {
...
module.exports = {
  ...
  editEntryFailure: editEntryFailure,
  getEntryHandlebars: getEntryHandlebars,
...
var authUi = __webpack_require__(3);
var getFormFields = __webpack_require__(28);
var authApi = __webpack_require__(30);
...
var onCreateEntry = function onCreateEntry(event) {
  ...
  var data = getFormFields(event.target);
  authApi.createEntry(data).then(authUi.createEntrySuccess).catch(authUi.createEntryFailure);
};

var onGetEntries = function onGetEntries(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.getEntries(data).then(authUi.getEntriesSuccess).catch(authUi.getEntriesFailure);
};
...
var onDeleteEntry = function onDeleteEntry(event) {
  ...
  .then(authUi.exitEntries).then(authApi.onGetEntries).catch(authUi.deleteEntryFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.entries : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "\n<div class=\"handlebars\" id=\"entry-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <div>\n    <h4 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"my-entry\"><u>Entry Date:</u> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "</h4>\n    <h4 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"my-entry\"><u>Thought:</u> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.thought : stack1), depth0))
    + "</h4>\n    <h4 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"my-entry\"><u>Cognitive Distortion:</u> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.distortion : stack1), depth0))
    + "</h4>\n    <h4 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"my-entry\"><u>Rational Response:</u> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.response : stack1), depth0))
    + "</h4>\n  <form class='delete-entry' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" id=\"entry-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n\n\n  <button id=\"delete-button-style-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" style=\"margin: 15px 5px;\" type= \"submit\" class=\"btn btn-danger btn-style delete-entry\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "'>DELETE</button>\n  </form>\n  <hr/>\n  </div>\n</div>\n\n";
  ...
  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.entries : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var addNestedValue = __webpack_require__(29);
...
var getEntries = function getEntries(data) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/entries',
    headers: {
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://mindful-api-1.herokuapp.com/',
